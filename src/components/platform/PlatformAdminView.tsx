...
export const PlatformAdminView: React.FC<PlatformAdminViewProps> = ({ onOpenNewTenantModal }) => {
  const { tenants, setCurrentTenant, setViewMode, currentUser } = useTenant();
                  ...
                  <td className="py-3 px-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 font-bold text-xs transition-colors"
                      >
                        Enter ERP
                      </button>
                      <button
